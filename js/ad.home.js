...
googletag.cmd.push(function () {
    ...
    var MediumRectangleHome = googletag.sizeMapping().
        addSize([1280, 200], [300, 250]).
        addSize([0, 0], [0, 0]).
        build();
    ...
    gptAdSlots[12] = googletag.defineSlot('/268136036/home-medium-rectangle-01', [300, 250], 'ad-medium-rectangle-01').
        defineSizeMapping(MediumRectangleHome).
        setCollapseEmptyDiv(true, true).
        addService(googletag.pubads());

    gptAdSlots[13] = googletag.defineSlot('/268136036/all-majorboard-01', [[300, 600], [320, 100]], 'ad-majorboard-01').
        defineSizeMapping(MajorboardAd).
        addService(googletag.pubads());

    gptAdSlots[14] = googletag.defineSlot('/268136036/all-majorboard-02', [[300, 600], [320, 100]], 'ad-majorboard-02').
        defineSizeMapping(MajorboardAd).
        addService(googletag.pubads());

    gptAdSlots[15] = googletag.defineSlot('/268136036/all-majorboard-03', [[300, 600], [320, 100]], 'ad-majorboard-03').
        defineSizeMapping(MajorboardAd).
        addService(googletag.pubads());

    gptAdSlots[16] = googletag.defineSlot('/268136036/all-majorboard-04', [[300, 600], [320, 100]], 'ad-majorboard-04').
        defineSizeMapping(MajorboardAd).
        addService(googletag.pubads());

    gptAdSlots[17] = googletag.defineSlot('/268136036/all-majorboard-05', [[300, 600], [320, 100]], 'ad-majorboard-05').
        defineSizeMapping(MajorboardAd).
        addService(googletag.pubads());

    gptAdSlots[18] = googletag.defineSlot('/268136036/home-highlightbox-01', ['fluid'], 'home-highlightbox-01').
        addService(googletag.pubads());

    gptAdSlots[19] = googletag.defineSlot('/268136036/os-sticky', [140, 290], 'ad-sticky').
        defineSizeMapping(StickyAd).
        addService(googletag.pubads());
    
    gptAdSlots[20] = googletag.defineSlot('/268136036/content-pc-01', ['fluid'], 'sponsor-content-pc-01').
        addService(googletag.pubads());
    
    gptAdSlots[21] = googletag.defineSlot('/268136036/content-pc-02', ['fluid'], 'sponsor-content-pc-02').
        addService(googletag.pubads());
